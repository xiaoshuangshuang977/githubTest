...
#define USER_LOGIN 		0x00000000  // login	          普通用户登陆    0x00000001
#define USER_MODIFY 	0x00000001  // user-modification  修改
#define USER_QUERY 		0x00000002  // user-query         查询

#define ADMIN_LOGIN 	0x10000000  // login			 管理员登陆    0x00000001
#define ADMIN_MODIFY 	0x10000001 // admin_modification 修改用户
#define ADMIN_ADDUSER 	0x10000002 // admin_adduser   	 添加用户
#define ADMIN_DELUSER 	0x10000004 // admin_deluser		 删除用户
#define ADMIN_QUERY 	0x10000008  //hitory_query 		 查询用户
#define ADMIN_HISTORY 	0x10000010  //hitory_query 		 查询历史用户 
